...
class PermissionUtils {
    companion object {
        ...
        val Manifest_READ_EXTERNAL_STORAGE = Manifest.permission
            .READ_EXTERNAL_STORAGE
        val Manifest_WRITE_EXTERNAL_STORAGE = Manifest.permission
            .WRITE_EXTERNAL_STORAGE
        val Manifest_ACCESS_FINE_LOCATION = Manifest.permission
            .ACCESS_FINE_LOCATION
        val Manifest_ACCESS_COARSE_LOCATION = Manifest.permission
        ...
        val Manifest_PROCESS_OUTGOING_CALLS = Manifest.permission
        ...
        val KEY_BODY_SENSORS = 50
        val KEY_READ_CALENDAR = 51
        val KEY_WRITE_CALENDAR = 52
        val KEY_READ_CONTACTS = 53
        val KEY_WRITE_CONTACTS = 54
        val KEY_GET_ACCOUNTS = 55
        val KEY_READ_EXTERNAL_STORAGE = 56
        val KEY_WRITE_EXTERNAL_STORAGE = 57
        val KEY_ACCESS_FINE_LOCATION = 58
        val KEY_ACCESS_COARSE_LOCATION = 59
        val KEY_RECORD_AUDIO = 60
        val KEY_READ_PHONE_STATE = 61
        val KEY_CALL_PHONE = 62
        val KEY_READ_CALL_LOG = 63
        val KEY_WRITE_CALL_LOG = 64
        val KEY_ADD_VOICEMAIL = 65
        val KEY_USE_SIP = 66
        val KEY_PROCESS_OUTGOING_CALLS = 67
        val KEY_CAMERA = 68
        val KEY_SEND_SMS = 69
        val KEY_RECEIVE_SMS = 70
        val KEY_READ_SMS = 71
        val KEY_RECEIVE_WAP_PUSH = 72
        val KEY_RECEIVE_MMS = 73
    }
}